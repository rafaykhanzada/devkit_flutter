...
class SlideRouteAnimationPage extends StatefulWidget {
  @override
  _SlideRouteAnimationPageState createState() => _SlideRouteAnimationPageState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, SlideRoute(page: DestinationPage()));
                    }
                ),
              ),
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, SlideRoute(page: DestinationPage(), slideFrom: 'right'));
                    }
                ),
              ),
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, SlideRoute(page: DestinationPage(), slideFrom: 'top'));
                    }
                ),
              ),
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, SlideRoute(page: DestinationPage(), slideFrom: 'bottom'));
                    }
                ),
              ),
            ],
