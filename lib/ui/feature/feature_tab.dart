      ...
      child: ListView(
        ...
        children: [
          ...
          _globalWidget.screenTabList(
              ...
              page: (!kIsWeb)?BarcodeScannerListPage():NotSupportedForWebPage(text: 'Package flutter_barcode_scanner')
          ),
          _globalWidget.screenTabList(
              context: context,
              id: number++,
          ...
          _globalWidget.screenTabList(
              ...
              page: (!kIsWeb)?PickPhotoPage():NotSupportedForWebPage(text: 'Package photofilters and permission_handler')
          ),
          _globalWidget.screenTabList(
              context: context,
              id: number++,
          ...
          _globalWidget.screenTabList(
              ...
              desc: 'Used to change picture',
              page: (!kIsWeb)?PickCropImagePage():NotSupportedForWebPage(text: 'Package image_cropper and permission_handler')
          ),
          _globalWidget.screenTabList(
              context: context,
              id: number++,
          ...
          _globalWidget.screenTabList(
              ...
              page: StorageLocationInformationPage()
          ),
          _globalWidget.screenTabList(
              context: context,
              id: number++,
          ...
          _globalWidget.screenTabList(
              ...
              page: (!kIsWeb)?WebviewListPage():NotSupportedForWebPage(text: 'Package webview_flutter')
          ),
        ],
      ),
    );
