...
class _ShareContent5PageState extends State<ShareContent5Page> {
  ...
  void _getImage(ImageSource source) async {
    final pickedFile = await _picker.getImage(source: source, maxWidth: 640, imageQuality: 100);
    setState(() {
      if (pickedFile != null) {
                        ...
                        child: _globalWidget.createButton(
                            ...
                            onPressed: (){
                              if(kIsWeb){
                                ...
                                Share.shareFiles([_selectedFile.path], text: 'This is text for Images', subject: 'This is subject for Images');
                              }
                            }
                        ),
                      ) : SizedBox.shrink()
