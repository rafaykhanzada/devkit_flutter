...
class TimeSeriesCharts6Page extends StatefulWidget {
  @override
  _TimeSeriesCharts6PageState createState() => _TimeSeriesCharts6PageState();
}

class _TimeSeriesCharts6PageState extends State<TimeSeriesCharts6Page> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Time Series Charts 6 (Time Series Charts - Show Points)',
                  desc: 'This is the example of time series charts - show points'
              ),
              Container(
