...
class TimeSeriesCharts2Page extends StatefulWidget {
  @override
  _TimeSeriesCharts2PageState createState() => _TimeSeriesCharts2PageState();
}

class _TimeSeriesCharts2PageState extends State<TimeSeriesCharts2Page> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Time Series Charts 2 (Time Series Charts - Start from Minimal Value)',
                  desc: 'This is the example of time series charts - start from minimal value and not from 0'
              ),
              Container(
