...
class TimeSeriesCharts5Page extends StatefulWidget {
  @override
  _TimeSeriesCharts5PageState createState() => _TimeSeriesCharts5PageState();
}

class _TimeSeriesCharts5PageState extends State<TimeSeriesCharts5Page> {
  ...
  void initState() {
    _series = [
      charts.Series(
          ...
          areaColorFn: (_, __) => charts.Color.fromHex(code: '#eeeeee'),
          data: _data
      )
    ];
    super.initState();
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Time Series Charts 5 (Time Series Charts - Area Color)',
                  desc: 'This is the example of time series charts - area color'
              ),
              Container(
