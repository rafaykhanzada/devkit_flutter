import 'package:devkitflutter/model/feature/stock_model.dart';
import 'package:devkitflutter/ui/reusable/global_widget.dart';
import 'package:flutter/material.dart';
import 'package:charts_flutter/flutter.dart' as charts;

class TimeSeriesCharts4Page extends StatefulWidget {
  @override
  _TimeSeriesCharts4PageState createState() => _TimeSeriesCharts4PageState();
}

class _TimeSeriesCharts4PageState extends State<TimeSeriesCharts4Page> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Time Series Charts 4 (Time Series Charts - Change Line Color and Thickness)',
                  desc: 'This is the example of time series charts - change line color and line thickness'
              ),
              Container(
                ...
                child: SizedBox(
                  ...
                  child: charts.TimeSeriesChart(
                    ...
                    defaultRenderer: charts.LineRendererConfig(
                        strokeWidthPx: 20 // change the line thickness
                    ),
