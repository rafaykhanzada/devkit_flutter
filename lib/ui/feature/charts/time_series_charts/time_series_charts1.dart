...
class TimeSeriesCharts1Page extends StatefulWidget {
  @override
  _TimeSeriesCharts1PageState createState() => _TimeSeriesCharts1PageState();
}

class _TimeSeriesCharts1PageState extends State<TimeSeriesCharts1Page> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Time Series Charts 1 (Simple Time Series Charts)',
                  desc: 'This is the example of simple time series charts'
              ),
              Container(
