...
class TimeSeriesCharts9Page extends StatefulWidget {
  @override
  _TimeSeriesCharts9PageState createState() => _TimeSeriesCharts9PageState();
}

class _TimeSeriesCharts9PageState extends State<TimeSeriesCharts9Page> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Time Series Charts 9 (Time Series Charts with Bar)',
                  desc: 'This is the example of simple time series charts with bar'
              ),
              Container(
