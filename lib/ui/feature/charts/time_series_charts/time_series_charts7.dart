...
class TimeSeriesCharts7Page extends StatefulWidget {
  @override
  _TimeSeriesCharts7PageState createState() => _TimeSeriesCharts7PageState();
}

class _TimeSeriesCharts7PageState extends State<TimeSeriesCharts7Page> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Time Series Charts 7 (Time Series Charts with Highlight On Press and Hold)',
                  desc: 'This is the example of time series charts with highlight on press and hold'
              ),
              Container(
