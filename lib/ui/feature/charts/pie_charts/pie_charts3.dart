import 'package:devkitflutter/model/feature/sales_color_model.dart';
import 'package:devkitflutter/ui/reusable/global_widget.dart';
import 'package:flutter/material.dart';
import 'package:charts_flutter/flutter.dart' as charts;

class PieCharts3Page extends StatefulWidget {
  @override
  _PieCharts3PageState createState() => _PieCharts3PageState();
}

class _PieCharts3PageState extends State<PieCharts3Page> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  title: 'Pie Charts 3 (Pie Charts with Color)',
                  desc: 'This is the example of pie charts with color'
              ),
              Container(
