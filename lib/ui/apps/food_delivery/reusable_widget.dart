                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 2),
                          Text(data[index].distance.toString()+' miles', style: GlobalStyle.textRatingDistances),
                        ],
                      ),
                      SizedBox(height: 6),
                      data[index].promo!=''
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      data[index].discount!=0
                          ? Text('\$ '+_globalFunction.removeDecimalZeroFormat(data[index].price), style: GlobalStyle.textPriceLineThrough) : SizedBox.shrink(),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu risus nec arcu cursus accumsan in id felis.', style: GlobalStyle.restaurantFoodDesc, maxLines: 3, overflow: TextOverflow.ellipsis)
                    ],
                  ),
                )
              ],
      ...
      return Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text('Address List', style: TextStyle(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: addressData[index]==address
                          ? Row(
                        children: [
                          Text(addressData[index], style: TextStyle(
                        ...
                        child: Text(addressData[index], style: TextStyle(
                            color: BLACK55, fontSize: 16
                        )),
                      ),
                    ),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Text('Delivery Information', style: GlobalStyle.deliveryInformationTitle, maxLines: 1, overflow: TextOverflow.ellipsis,
          ),
        ),
        Container(
          padding: EdgeInsets.all(16),
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    height: 24,
                    child: Center(
                        child: Icon(Icons.location_pin, size: 24, color: ASSENT_COLOR)
                    ),
                  ),
                  SizedBox(width: 8),
                  Flexible(
              ...
              Text('Note to driver', style: GlobalStyle.deliveryInformationNoteTitle),
              SizedBox(height: 4),
              Text('Meet me at the car park', style: GlobalStyle.deliveryInformationNoteValue)
            ],
          ),
        )
      ],
