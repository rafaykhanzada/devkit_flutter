          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Text('Text direction from left to right', style: TextStyle(color: SOFT_BLUE))
              ),
              Container(
              ...
              Container(
                  margin: EdgeInsets.only(top: 10),
                  child: Text('Text direction from right to left', style: TextStyle(color: SOFT_BLUE))
              ),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: Wrap(
