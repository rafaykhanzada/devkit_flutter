...
class NotSupportedForWebPage extends StatefulWidget {
  ...
  const NotSupportedForWebPage({Key? key, required this.text}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Container(
                  child: Text(widget.text+' are not supported for web when the latest version of DevKit is released.\n\n'
